...
PUBLICVPNLIST_API_TIMEOUT_SECONDS = _publicvpnlist_env_int("PUBLICVPNLIST_API_TIMEOUT_SECONDS", 20, 1)
PUBLICVPNLIST_API_MAX_RETRIES = _publicvpnlist_env_int("PUBLICVPNLIST_API_MAX_RETRIES", 2, 1)
